...
declare module '@tanstack/react-table' {
  interface TableMeta<TData extends RowData> {
    updateData: (
      ...
      columnId: string,
      value: unknown,
      row: Row<TransactionTableColumns>,
    ) => void;
  }
}

// Give our default column cell renderer editing superpowers!
const defaultColumn: Partial<ColumnDef<TransactionTableColumns>> = {
  cell: ({
    getValue,
    row: { index },
    row,
    ...
    const onBlur = () => {
      table.options.meta?.updateData(index, id, columnDef, row);
    };
...
export function TestTransactionTable(props: any) {
  ...
  const columns = React.useMemo<ColumnDef<TransactionTableColumns>[]>(
    () => [
      {
        header: 'id',
        accessorKey: 'id',
